...
if __name__ == "__main__":
    ...
    if args.parallel == True:
        ...
        torch.save(actor.state_dict(), os.path.join(basepath, 'checkpoints/Historical_kuhn' + '_actor'))
        torch.save(critic.state_dict(), os.path.join(basepath, 'checkpoints/Historical_kuhn' + '_critic'))
    else:
        seed = 154
