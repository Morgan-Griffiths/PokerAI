...
if __name__ == '__main__':
    ...
    if args.mkfolders:
        ...
        Path('hand_recognition/data/multiclass_categorization/flatdeck/train').mkdir(parents=True, exist_ok=True)
        Path('hand_recognition/data/multiclass_categorization/flatdeck/val').mkdir(parents=True, exist_ok=True)
