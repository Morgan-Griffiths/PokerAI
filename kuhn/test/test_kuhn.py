...
from env import Poker
from data_classes import Card,Evaluator
...
class TestEnv(unittest.TestCase):
    ...
    def TestRlEnvironments(self):
        os.system('python kuhn/kuhn_main.py --env kuhn -e 2 --no-clean --no-store')
        os.system('python kuhn/kuhn_main.py --env complexkuhn -e 2 --no-clean --no-store')
        os.system('python kuhn/kuhn_main.py --env betsizekuhn -e 2 --no-clean --no-store')
        os.system('python kuhn/kuhn_main.py --env historicalkuhn -e 2 --no-clean --no-store')
        os.system('python kuhn/kuhn_main.py --env historicalkuhn -e 5 --parallel --no-clean --no-store')
