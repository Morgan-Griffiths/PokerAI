...
if __name__ == "__main__":
    ...
    if args.single:
        ...
        for e in range(training_params['lr_steps']):
            ...
            tic = time.time()
            if args.batch:
                mp.spawn(train_batch,args=(env_params,training_params,learning_params,network_params,validation_params),nprocs=num_gpus,join=True)
            else:
                mp.spawn(train_dual,args=(env_params,training_params,learning_params,network_params,validation_params),nprocs=num_gpus,join=True)
